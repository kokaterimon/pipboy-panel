...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    //permitir mostrar un screen
    //private bool allowToSetScreen; //true ==> allow
    ...
    //BR------------------------------------------------------------------------
    public void GoToSpecificScreen(int specificScreenNumber)
    {
        //SetPage(specificScreenNumber);
        //if (allowToSetScreen)
        //{
            LerpToPage(specificScreenNumber);
            //_currentPage = specificScreenNumber;
        //}        
    }
    ...
    public void OnBeginDrag(PointerEventData aEventData) {
        ...
        //SendMessage("INeedToScrollScreen", true);
    }
    ...
    public void OnEndDrag(PointerEventData aEventData) {
        ...
        float difference;
        if (_horizontal) {
            //BR: si va a la izquierda la diferencia es ==> positiva
            //BR: si va a la derecha la diferencia es ==> negativa
        ...
        //BR: para reemplazar el if anterior
        if (difference > 0 && Mathf.Abs(difference) > 30)
        {
            NextScreen();
        }
        else if(difference < 0 && Mathf.Abs(difference) > 30)
        {
            PreviousScreen();
        }
        SendMessage("ScrollButtonsWhenClicked", _currentPage); //LerpToPage ya modificó el valor de currentpage
        _dragging = false;

        //SendMessage("INeedToScrollScreen", false);
        //SendMessage("ScrollButtonsWhenDragged", GetNearestPage());

        //allowToSetScreen = true;
    }
